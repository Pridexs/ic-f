...
auto.arima(uscheese.training, lambda=uscheese.training.lambda)
```

Uma diferenciacao pareceu ser suficiente.

```{r}
Arima(uscheese.training, c(0,1,0), lambda=uscheese.training.lambda)
#Arima(uscheese.training, c(9,1,0), lambda=uscheese.training.lambda)
#Arima(uscheese.training, c(0,1,9), lambda=uscheese.training.lambda)
#Arima(uscheese.training, c(0,1,10), lambda=uscheese.training.lambda)
